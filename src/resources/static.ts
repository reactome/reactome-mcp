...
export function registerStaticResources(server: McpServer) {
  // All species
  server.resource("reactome://species", "reactome://species", async () => {
  ...
  // Main species
  server.resource("reactome://species/main", "reactome://species/main", async () => {
  ...
  // Diseases
  server.resource("reactome://diseases", "reactome://diseases", async () => {
  ...
  // Database info
  server.resource("reactome://database/info", "reactome://database/info", async () => {
